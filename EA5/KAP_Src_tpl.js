var app = ( function() {
 ...
 function createModel(geometryname, fillstyle) {
	...
	function initEventHandler() {
		...
		window.onkeydown = function(evt) {
			...
			switch(c) {
				...
				case('\'')://right
					...
					break;
				case('N')://right
					var currentRadiusScale = document.getElementById("radius");
					if(sign > 0 && currentScale < 10 || sign < 0 && currentScale > 1){
						currentScale += sign * 1;
						currentRadiusScale.innerHTML = "Aktueller Radius Multiplikator = " + currentScale;
						deltaRotate += sign * Math.PI / 36 ;
						deltaTranslate += sign * 0.05 ;
						break;
					}
			}
		...
		var slider = document.getElementById("depthInput");
