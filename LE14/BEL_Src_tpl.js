    ...
    function initEventHandler() {
        ...
        window.onkeydown = function(evt) {
            ...
            case ('I'):
                ...
                illumination.light[0].position[0] = Math.sin(deltaTranslateLight) * r;
                illumination.light[0].position[2] = Math.cos(deltaTranslateLight) * r;
    
                illumination.light[1].position[0] = Math.sin(deltaTranslateLight) * -r;
                illumination.light[1].position[2] = Math.cos(deltaTranslateLight) * -r;
                break;
            case ('L'):
                if(deltaTranslate < 0 ){
                    deltaTranslate = 0;
